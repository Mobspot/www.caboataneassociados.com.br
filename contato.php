...
<body>
    ...
    <main class="site-main">
        <section class="services">
            ...
            <form id="contact" action="/commons/enviaForm.php" method="GET">
               ...
               <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="email" id="email" class="form-control" placeholder="Seu E-mail *" value="" />
                        </div>
                        <div class="form-group">
                            <input type="text" name="celular" id="celular" class="form-control" placeholder="Telefone Celular *" value="" />
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <textarea name="mensagem" id="mensagem" class="form-control" placeholder="Deixe sua mensagem aqui  *" style="width: 100%; height: 150px;"></textarea>
                        </div>
                    </div>
                </div>
            </form>
