...
bike &&
    ((function () {
        for (var i = bike.querySelectorAll(".tab>input[type=checkbox]"), e = 0; e < i.length; e++) {
            var t = i[e];
            (t.checked = !1), $(t).closest(".content").slideUp(600);
        }
        (i[0].checked = !0), window.innerWidth <= 1024 && $(document).find("#bike .bikeMobile .content>div").eq(0).slideDown(600), $(i[0]).closest(".content-mobile").slideDown(600);
                ...
                $(o)
                    ...
                    .change(function (e) {
                        ...
                        for (var e = !!o.checked, t = 0; t < i.length; t++) {
                            var n = i[t];
                            (n.checked = !1), $(n).closest(".content-mobile").slideUp(600);
                        }
                        (o.checked = e),
                            o.checked ? $(o).closest(".content-mobile").slideDown(600) : $(o).closest(".content-mobile").slideUp(600),
                            window.innerWidth <= 1024 &&
                                ((e = $(o).attr("id")),
                                $(o)
                                    .closest(".bikeMobile")
